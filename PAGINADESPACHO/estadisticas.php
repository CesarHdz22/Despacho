...
?><a class="nav-link" href="esta.php" >
            ...
            <button onclick="CargarDatosGraficoBar()" class="botones" id="cargar" hidden>Cargar Ganancias</button>
            <canvas id="esta" height="150" width="150" style="position:relative; top:5em;"></canvas>
                </section>
...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    // Llamada a la función de clic automático
    autoClick();
  });

function CargarDatosGraficoBar(){
    $.ajax({
    url: 'controlador_graficoCasos.php',
    type: 'POST'
}).done(function(resp) {
    var titulo = [];
    var cantidad = [];
    ...
    const ctx = document.getElementById('esta');
