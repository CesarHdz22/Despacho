...
<?php } ?>
                            ...
                            <a class="nav-link" href="clientes.php">
                                <div class="sb-nav-link-icon"><img src="assets/img/usuarios.png" height="20px" width="20px"></div>
                                Clientes
                            </a>
            ...
            <main>
				...
				?>
					<tr>
                        ...
                        <td class="celdas_tablas"><?php echo $mostrar['direccion'] ?></td>
				...
				?>
                            ...
                            </div> </tbody><button class="datatable-selector1">AGREGAR</button>
