...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar-a navbar-expand navbar-dark bg-dark-a">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3-a" href="index.php">Despacho</a>
            <!-- Sidebar Toggle-->
...
?><a class="nav-link" href="esta.php" >
            ...
            <div id="layoutSidenav_content">
                ...
                if ($cargo=="San Pedro") {
                    ...
                    $sql="SELECT * FROM usuarios WHERE cargo != 'San Pedro'";
                }
				...
				?>
					<tr>
						...
						<td class="celdas_tablas"><?php echo $mostrar['id_usuario'] ?></td>
                        <td class="celdas_tablas"><?php echo $mostrar['usuario'] ?></td>
                        ...
                        <td class="celdas_tablas"><?php echo $mostrar['correo'] ?></td>
                        
                        <td class="celdas_tablas"><?php 
                        if ($mostrar['cargo'] =="San Pedro") {
                            echo "Administrador Principal";
                        }else{
                        echo $mostrar['cargo']; } ?> </td>
                        <td class="celdas_tablas"><center>  <a href="editaru.php?id=<?php echo $mostrar['id_usuario'];?>"> <img width="35px" src="assets/img/edicion.png"> </a>   </center></td>
                        
                        
                        <td class="celdas_tablas"><center><a href="alertita.php?id=<?php echo $mostrar['id_usuario'] ?>&u=<?php echo $mostrar['usuario'] ?>&idu=<?php echo $id ?>"> <img width="35px" src="assets/img/borrar-usuario.png"></a></center></td>
...
?>
                            ...
                            </div> <button  onclick="location.href='ausuario.php' ">AGREGAR</button>
                            </div>
