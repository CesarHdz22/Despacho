        ...
        <div class="container-fluid px-4">
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <b> Historial de Actividades: <?php
                    $expediente = $_GET["e"]; 
                    echo $expediente; ?></b>
                </div>
                <div class="card-body">
                    <table id="datatablesSimple" class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM histact WHERE expediente='$expediente' ORDER BY f_fin ASC";
        ...
        <div class="container-fluid px-4">
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    ?>
                    <b><?php echo $mostrar['expediente'], "-", $mostrar['juicio']; ?></b>
                </div>
                <div class="card-body">
                    <table id="datatablesSimple" class="table table-bordered">
                        <thead>
